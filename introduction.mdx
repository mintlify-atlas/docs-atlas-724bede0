...
<Columns cols={3}>
  ...
  <Card title="Integer quantization" icon="microchip">
    Supports integer quantization (e.g. 4-bit, 8-bit) to reduce memory usage
    and accelerate inference on constrained hardware.
  </Card>
  <Card title="Automatic differentiation" icon="arrows-rotate">
    Supports forward and backward passes for training, with ADAM and L-BFGS
    optimizers built in.
  </Card>
